...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="header border-bottom bg-primary">    
            ...
            <div class="header-content clearfix">
                ...
                <div class="nav-control">
                    ...
                    <span class="font-weight-bold text-white">Welcome To  Dashboard</span>
                                ...
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <form method="get" action="{{ url('stafflogout') }}">
                                                @csrf
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ url('staffdashboard') }}" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url('dsrproductrecivedlist')}}">Receive Lists</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url('dsrstocks')}}">Stocks</a></li>
                        </ul>
                    </li>
