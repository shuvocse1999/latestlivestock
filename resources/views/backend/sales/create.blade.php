				...
				<div class="col-md-12">
					...
					<div class="form-group col-md-12">
									...
									<div class="input-group mb-2">
										...
										"product_id"  onchange="return salescurrentcart()">
										<option value="">- - - - -</option>
...
<script type="text/javascript">
	...
	function salescurrentcart(){
		let id = $("#product_id").val();

		$.ajax({
			url: "{{ url('salescurrentcart') }}/"+id,
			type: 'GET',
			success: function (data)
			{
	...
	function showsalescurrentcart(){

		$.ajax({
			url: "{{ url('showsalescurrentcart') }}",
			type: 'get',
			data:{},
			success: function (data)
			{
	...
	function salesreturncartonupdate(id){
		...
		$.ajax({
			url: "{{ url('salesreturncartonupdate') }}/"+id,
			type: 'get',
	...
	function salesreturnpieceupdate(id){
		...
		$.ajax({
			url: "{{ url('salesreturnpieceupdate') }}/"+id,
			type: 'get',
	...
	$(".btn-submit").submit(function(e){
		...
		$.ajax({
			...
			success:function(response){
				...
				window.open('{{URL::to('/editsales')}}'+'/'+response);
				location.reload();
