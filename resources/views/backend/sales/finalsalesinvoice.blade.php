...
@if($sqty > 0 || $p->damage > 0)
  ...
  <tr>
    ...
    <td>@if($p->returnscarton > 0) {{ $p->returnscarton }} @else 0 @endif - @if($p->returnspiece > 0) {{ $p->returnspiece }} @else 0 @endif</td>
    <td>@if($finalsalescartons > 0) {{ $finalsalescartons }} @else 0 @endif - @if($finalsalesremainingPieces > 0) {{ $finalsalesremainingPieces }} @else 0 @endif</td>
    <td>{{ $p->free }}</td>
    <td>{{ $p->damage }}</td>
    <td>{{ $p->sales_price }}</td>
    <td class="text-right">
