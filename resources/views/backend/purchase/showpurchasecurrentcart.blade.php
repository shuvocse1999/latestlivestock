		...
		<tr id="tr{{ $d->id }}">
			...
			<td width="100">
				...
				$piece_price = $d->purchase_price/$product->unit_per_group;
				$totalpieceprice = $piece_price*$d->piece;
				$subtotal = ($d->carton*$d->purchase_price)+$totalpieceprice;
				$totalpurchaseamount = $totalpurchaseamount+$subtotal;
				@endphp
				<div class="input-group">
					<input type="text" class="form-control" readonly="" value="{{ number_format($subtotal,2) }}">
