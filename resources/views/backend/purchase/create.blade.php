			...
			<div class="card">
				<div class="card-body">
					...
					<form method="post" class="btn-submit" enctype="multipart/form-data">
						...
						<div class="col-md-12 p-0 row">
							...
							<div class="form-group col-md-3">
								...
								<div class="input-group mb-2">
									...
									"supplier_id" required="" onchange="return getprevdue();">
						...
						<div class="form-group col-md-2">
							<label class="mb-1">Previous Due: </label>
							<div class="input-group mb-2">
								<input type="text" name="" readonly="" id="prevdue" class="form-control text-primary">
							</div>
						</div>
					...
					<div class="col-md-12 p-0" style="height: 500px!important; overflow: auto; overflow-x: hidden;">
						<table class="table table-bordered">
...
<script type="text/javascript">
	...
	function getprevdue(){
		...
		if (supplier_id === 0) {
			...
			$.ajax({
				url: "{{ url("getprevdue") }}/"+supplier_id,
				type: "get",
				success: function (response) {

					$("#prevdue").val(response);
				}
			});
	...
	$(".btn-submit").submit(function(e){
		...
		$.ajax({
			...
			success:function(response){
				...
				window.open('{{URL::to('/purchaseinvoice')}}'+'/'+response, "blank");
				location.reload();
